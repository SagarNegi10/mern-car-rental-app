      ...
      <div className='grid grid-cols-1 lg:grid-cols-3 gap-8 lg:gap-12'>
        ...
        <form onSubmit={handleSubmit} className='shadow-lg h-max sticky top-18 rounded-xl p-6 space-y-6 text-gray-500'>
          ...
          <div className='flex flex-col gap-2'>
            ...
            <input type="date" className='border border-borderColor px-3 py-2 ronuded-lg' id="pickup-date" min={new Date().toISOString().split('T')[0]} required/>
          </div>

          <div className='flex flex-col gap-2'>
            <label htmlFor="return-date">Return Date</label>
            <input type="date" className='border border-borderColor px-3 py-2 ronuded-lg' id="reaturn-date" required/>
          </div>
